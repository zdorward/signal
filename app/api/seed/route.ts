...
const candidates = [
  { name: 'C 1', scores: { q1c1: 5, q1c2: 5, q2c1: 5, q2c2: 5 }, url_passed: true, video_score: 9, video_summary: 'AI tax optimization tool' },
  { name: 'C 2', scores: { q1c1: 4, q1c2: 4, q2c1: 4, q2c2: 4 }, url_passed: true, video_score: 7, video_summary: 'Portfolio rebalancing automation' },
  { name: 'C 3', scores: { q1c1: 5, q1c2: 4, q2c1: 5, q2c2: 4 }, url_passed: true, video_score: 8, video_summary: 'AI financial coaching app' },
  { name: 'C 4', scores: { q1c1: 4, q1c2: 4, q2c1: 4, q2c2: 4 }, url_passed: true, video_score: 6, video_summary: 'Fraud detection with human oversight' },
  { name: 'C 5', scores: { q1c1: 4, q1c2: 4, q2c1: 4, q2c2: 3 }, url_passed: true, video_score: 5, video_summary: 'AI retirement planning system' },
  { name: 'C 6', scores: { q1c1: 4, q1c2: 4, q2c1: 4, q2c2: 4 }, url_passed: true, video_score: 6, video_summary: 'Investment research AI assistant' },
  { name: 'C 7', scores: { q1c1: 4, q1c2: 3, q2c1: 4, q2c2: 3 }, url_passed: true, video_score: 4, video_summary: 'Budget categorization bot' },
  { name: 'C 8', scores: { q1c1: 4, q1c2: 4, q2c1: 3, q2c2: 4 }, url_passed: true, video_score: 7, video_summary: 'Expense tracking system' },
  { name: 'C 9', scores: { q1c1: 3, q1c2: 4, q2c1: 3, q2c2: 4 }, url_passed: true, video_score: 5, video_summary: 'Stock alert notifications' },
  { name: 'C 10', scores: { q1c1: 4, q1c2: 3, q2c1: 4, q2c2: 3 }, url_passed: true, video_score: 3, video_summary: 'Savings gamification app' },
  { name: 'C 11', scores: { q1c1: 3, q1c2: 4, q2c1: 4, q2c2: 3 }, url_passed: true, video_score: 6, video_summary: 'Crypto portfolio tracker' },
  { name: 'C 12', scores: { q1c1: 4, q1c2: 4, q2c1: 3, q2c2: 4 }, url_passed: false, video_score: 7, video_summary: 'AI bill splitting app' },
  { name: 'C 13', scores: { q1c1: 4, q1c2: 3, q2c1: 4, q2c2: 3 }, url_passed: true, video_score: 4, video_summary: 'Financial news summarizer' },
  { name: 'C 14', scores: { q1c1: 3, q1c2: 4, q2c1: 3, q2c2: 4 }, url_passed: true, video_score: 5, video_summary: 'Subscription manager tool' },
  { name: 'C 15', scores: { q1c1: 3, q1c2: 3, q2c1: 3, q2c2: 3 }, url_passed: true, video_score: 3, video_summary: 'Unrelated todo app' },
  { name: 'C 16', scores: { q1c1: 2, q1c2: 2, q2c1: 2, q2c2: 2 }, url_passed: true, video_score: 2, video_summary: 'Personal portfolio website' },
  { name: 'C 17', scores: { q1c1: 3, q1c2: 4, q2c1: 3, q2c2: 3 }, url_passed: false, video_score: 6, video_summary: 'Basic ML demo' },
  { name: 'C 18', scores: { q1c1: 4, q1c2: 3, q2c1: 3, q2c2: 4 }, url_passed: true, video_score: 4, video_summary: 'Basic hello world repo' },
  { name: 'C 19', scores: { q1c1: 3, q1c2: 3, q2c1: 4, q2c2: 3 }, url_passed: true, video_score: null, video_summary: null },
  { name: 'C 20', scores: { q1c1: 3, q1c2: 4, q2c1: 4, q2c2: 3 }, url_passed: true, video_score: 8, video_summary: 'Solid AI assistant demo' },
];
